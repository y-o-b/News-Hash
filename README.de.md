...
- `codec_name` wählt die aktive quellspezifische Verarbeitung. Standard ist `RSSv2`; historische v0- und v1-Codecs stehen nur für die Validierung zur Verfügung.
